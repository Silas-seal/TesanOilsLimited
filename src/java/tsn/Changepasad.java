 ...
 * @author SeumX Plus
 */
@WebServlet(name = "Changepasad", urlPatterns = {"/Changepasad"})
public class Changepasad extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                if(rs.next() && rs.getString("title").equals("administrator")) {
                    ...
                    out.println("<form action=\"Savepasad\" method=\"post\">"
                            + "<input type=\"hidden\" name=\"name\" value=\""+rs.getString("name")+"\" />"
                            + "<input type=\"text\" name=\"old\" placeholder=\"Enter Current Password\" /> <p/>"
                            + "<input type=\"text\" name=\"new\" placeholder=\"Enter New Password\" /> <p/>"
