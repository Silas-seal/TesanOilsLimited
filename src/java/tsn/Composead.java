 ...
 * @author SeumX Plus
 */
@WebServlet(name = "Composead", urlPatterns = {"/Composead"})
public class Composead extends HttpServlet {
            ...
            try {
                ...
                if(rs.next() && rs.getString("title").equals("administrator")) {
                    ...
                    out.println("<table border=\"0\" cellpadding=\"5\" cellspacing=\"5\" bgcolor=\"white\">"
                            ...
                            + "<li><a href=\"Composead\" ><font face=\"Cambria\" size=\"+1\" color=\"azure\"><i>Compose</i> </a> </li>"
                            + "</td><td valign=\"top\" bgcolor=\"slateblue\">"
