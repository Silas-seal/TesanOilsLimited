 ...
 * @author SeumX Plus
 */
@WebServlet(name = "Delmailad", urlPatterns = {"/Delmailad"})
public class Delmailad extends HttpServlet {
                ...
                if(rs.next() && rs.getString("title").equals("administrator")) {
                    out.println(head);
                        ...
                        out.println("<td valign=\"top\"><table border=\"2\" cellpadding=\"4\" cellspacing=\"4\" bgcolor=\"darkred\">"
                                ...
                                //deleting mail
                    String qr1="update mail set m_type=\"trush\" where ID=?"; PreparedStatement ps; 
                    ps=con.prepareStatement(qr1); ps.setString(1,request.getParameter("id"));
                    ps.executeUpdate();
