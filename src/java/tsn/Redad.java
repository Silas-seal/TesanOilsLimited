 ...
 * @author SeumX Plus
 */
@WebServlet(name = "Redad", urlPatterns = {"/Redad"})
public class Redad extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                if(rs.next() && rs.getString("title").equals("administrator")) {
                    ...
                    PreparedStatement p; p=con.prepareStatement(qr); p.setString(1,ck.getValue()); p.setString(2,"read");
                    ...
                    out.println("<table border=\"0\" cellpadding=\"5\" cellspacing=\"5\" bgcolor=\"white\">"
                            ...
                            + "</li> <li><a href=\"Redad\" ><font face=\"Cambria\" size=\"+1\" color=\"azure\"><i>Old</i></font> </a> </li>"
                    ...
                    while(r.next()) {
                        out.println(""
                                + "<tr><td>"+r.getString("m_tofro")+"</td> <td>"+r.getString("m_date")+"</td><td>"+r.getString("m_subject")+"</td>"
                                        + "<td>"+r.getString("m_content")+"</td><td><form action=\"Readad\" method=\"post\">"
