 ...
 * @author SeumX Plus
 */
@WebServlet(name = "Sentad", urlPatterns = {"/Sentad"})
public class Sentad extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                if(rs.next() && rs.getString("title").equals("administrator")) {
                    ...
                    PreparedStatement p; p=con.prepareStatement(qr); p.setString(1,ck.getValue()); p.setString(2,"sent");
                    ...
                    out.println("<table border=\"0\" cellpadding=\"5\" cellspacing=\"5\" bgcolor=\"white\">"
                            ...
                            + "<li><a href=\"Mailad\" ><font face=\"Cambria\" size=\"+1\" color=\"black\"><i>New</i></font> </a> "
                            + "</li> <li><a href=\"Redad\" ><font face=\"Cambria\" size=\"+1\" color=\"black\"><i>Old</i></font> </a> </li>"
                            + "<li><a href=\"Sentad\" ><font face=\"Cambria\" size=\"+1\" color=\"azure\"><i>Sent</i> </font></a> </li> "
                    ...
                    while(r.next()) {
                        out.println(""
                                + "<tr><td>"+r.getString("m_tofro")+"</td> <td>"+r.getString("m_date")+"</td><td>"+r.getString("m_subject")+"</td>"
                                        + "<td>"+r.getString("m_content")+"</td><td><form action=\"Delmailad\" method=\"post\">"
                                        + "<input type=\"hidden\" name=\"id\" value=\""+r.getString("ID")+"\" />"
                                                + "<button type=\"submit\" style=\"background-color:navy\">"
                                + "<font face=\"Cambria\" size=\"+1\" color=\"azure\">Delete</font> </button> </form></td> </tr>");
                    }
