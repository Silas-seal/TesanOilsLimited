...
<html>
    ...
    <center>
        ...
        <div style="background-color:navy">
            <a href="index.jsp"><button type="button" style="background-color: navy"> <font face="Times new roman" size="+2" color="azure">
                    Home</font> </button> </a>
    ...
    <div style="background-color: white">
        <table border="0" bordercolor="orange" cellpadding="4" cellspacing="4">
            ...
            <tr>
                <td valign="top" halign="left" bgcolor="lightsteelblue">
                    <ul>
                        ...
                        <li><a href=""><font face="Cambria" size="+1" color="black"><i>Location</i></font></a></li>
            ...
            <td> <form action="Login" method="post"> 
                    ...
                    Username : <input type="text" name="username" maxlength="70" placeholder="username"/> <br/> <br/>
                    Password : <input type="password" name="password" maxlength="70" placeholder="password"/> <br/> <br/>
                    <button type="submit" width="270" height="31" style="background-color: darkgreen"> <font face="Cambria" size="+2" color="azure"> 
                        LOGIN  </font>
                    </button> <p/>  <a href="fgtpas.jsp"> <i><b>Forgot Password</b></i></a> <p/>
                    
                    <font face="Times new roman" size="+1" color="darkred">Please contact <a href="">SeumxPlus</a> for a password reset.</font>
                    </font> </form> 
                </td> 
